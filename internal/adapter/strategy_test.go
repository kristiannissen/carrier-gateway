...
func TestRegistry_Carriers(t *testing.T) {
	...
	assert.ElementsMatch(t, []string{"postnl", "postnord", "bring", "gls", "dao", "dhl", "inpost", "fedex", "hermes", "dhl_express", "omniva", "dpd_uk", "evri", "dhl_ecommerce_uk", "speedy", "econt", "matkahuolto"}, carriers)
}
