...
func TestRegistry_Select(t *testing.T) {
	...
	t.Run("known carriers return an adapter", func(t *testing.T) {
		t.Parallel()
		for _, carrier := range []string{"postnord", "bring", "gls", "dao", "dhl", "inpost", "fedex", "ufficiopostale"} {
...
func TestRegistry_Carriers(t *testing.T) {
	...
	assert.ElementsMatch(t, []string{"postnl", "postnord", "bring", "gls", "dao", "dhl", "inpost", "fedex", "hermes", "dhl_express", "dpd_nl", "omniva", "dpd_uk", "evri", "dhl_ecommerce_uk", "speedy", "econt", "matkahuolto", "ufficiopostale"}, carriers)
}
...
func TestRegistry_StrategyExecution(t *testing.T) {
	...
	carriers := []string{"postnord", "bring", "gls", "dao", "dhl", "inpost", "fedex", "ufficiopostale"}
